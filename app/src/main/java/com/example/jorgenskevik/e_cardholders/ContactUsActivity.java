...
//public static final String phoneNumber = "tel:72894940";
    public static final String phoneNumber = "tel:99016757";
    public static final String emailNumber = "hege.arntzen@norskrestaurantskole.no";
    ...
    public void OpenMail(View view){
        ...
        intent.putExtra(android.content.Intent.EXTRA_EMAIL, new String[] {"hege.arntzen@norskrestaurantskole.no"});
